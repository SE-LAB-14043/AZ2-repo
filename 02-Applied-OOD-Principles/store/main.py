...
def build_demo_orders():
    ...
    headphones = Order(
        ...
        items=[OrderItem(5, "Headphones", 79.99, 1)],
    )

    return laptop, books, bundle, headphones


def main() -> None:
    service = OrderService()
    laptop, books, bundle, headphones = build_demo_orders()
    ...
    service.process_order(headphones)
